...
router.post('/', async (req, res) => {
  try {
    ...
    const user = new User({ name, email, password: hashedPassword, age, gender, phone });
    await user.save();
...
router.post('/login', async (req, res) => {
  ...
  try {
    ...
    const passwordMatch = isHashed ? await bcrypt.compare(password, user.password) : password === user.password;
